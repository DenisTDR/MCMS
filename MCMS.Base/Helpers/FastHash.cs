...
namespace MCMS.Base.Helpers
{
    public static class FastHash
    {
        ...
        {
            return SuperFastHashUInt16Hack.Hash(Encoding.ASCII.GetBytes(src)).ToString();
        }
    }

    // code stolen from: http://landman-code.blogspot.com/2009/02/c-superfasthash-and-murmurhash2.html
