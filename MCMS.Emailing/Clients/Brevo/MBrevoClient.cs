...
public class MBrevoClient : IMEmailClient
{
    private readonly ILogger _logger;
    private readonly MBrevoClientOptions _options;

    public MBrevoClient(ILoggerFactory loggerFactory, IOptions<MBrevoClientOptions> clientOptions)
    {
